...
if (! class_exists('Untappd_Settings')) {

    /**
     * Handles plugin settings and user profile meta fields
     */
    class Untappd_Settings extends Untappd_Module
    {
        protected $settings;
         ...
         * @param array  $value This will be merged with Untappd_Settings->settings, so it should mimic the structure of the Untappd_Settings::$default_settings. It only needs the contain the values that will change, though. See Untappd_Plugin->upgrade() for an example.
         */
        public function __set($variable, $value)
        {
            // Note: Untappd_Module::__set() is automatically called before this
            ...
            update_option('untappd_settings', $this->settings);
        }
        ...
        protected static function get_settings()
        {
            $settings = shortcode_atts(
                ...
                get_option('untappd_settings', array())
            );
        ...
        public static function markup_settings_page()
        {
            if (current_user_can(self::REQUIRED_CAPABILITY)) {
                echo self::render_template('untappd-settings/page-settings.php');
            } else {
        ...
        {
            echo self::render_template('untappd-settings/page-settings-section-headers.php', array( 'section' => $section ), 'always');
        }
        ...
        public function markup_fields($field)
        {
            ...
            echo self::render_template('untappd-settings/page-settings-fields.php', array( 'settings' => $this->settings, 'field' => $field ), 'always');
        }
