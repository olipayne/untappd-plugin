 ...
 */
if ( ! class_exists( 'UntappdTestSuite' ) ) {
	class UntappdTestSuite extends TestSuite {
		function __construct() {
			parent::__construct();

			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-untappd-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-untappd-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-untappd-instance-class.php' );
		}
