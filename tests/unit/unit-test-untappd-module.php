...
require_once( dirname( dirname( __DIR__ ) ) . '/classes/untappd-module.php' );

/**
 * Unit tests for the Untappd_Module class
 * Uses the SimpleTest For WordPress plugin
 *
 * @link http://wordpress.org/extend/plugins/simpletest-for-wordpress/
 */
if ( ! class_exists( 'UnitTestUntappd_Module' ) ) {
	class UnitTestUntappd_Module extends UnitTestCase {
		/*
		 * get_instance()
		 */
		public function test_get_instance() {
			// Two instances of the same module
			$first_instance = UntappdChildClass::get_instance();
			$first_instance->init();
			$first_instance->foo = 'first';

			$second_instance = UntappdChildClass::get_instance();
			...
			$separate_module = UntappdAnotherChildClass::get_instance();
		...
		public function test_magic_get() {
			$child = UntappdChildClass::get_instance();
	...
	} // end UnitTestUntappd_Module
}

// Mock up a child class
if ( ! class_exists( 'UntappdChildClass' ) ) {
	class UntappdChildClass extends Untappd_Module {
...
// Mock up a child class
if ( ! class_exists( 'UntappdAnotherChildClass' ) ) {
	class UntappdAnotherChildClass extends Untappd_Module {
